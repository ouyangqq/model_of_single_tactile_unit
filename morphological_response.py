...
from common import ultils as alt
import pandas as pd
...
'''
plt.figure(figsize=(12,4.5)) 
spikes=tsa1.spike_trains[0][:]
plt.scatter(spikes,np.ones(len(spikes)))
'''
filepath='/home/justin/share/figures_materials/single_receptor/'
filepath='saved_figs/'
plt.savefig(filepath+'Morphological_response1.png',bbox_inches='tight', dpi=300)
